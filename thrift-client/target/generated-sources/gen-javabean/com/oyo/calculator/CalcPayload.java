...
public class CalcPayload implements org.apache.thrift.TBase<CalcPayload, CalcPayload._Fields>, java.io.Serializable, Cloneable, Comparable<CalcPayload> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CalcPayload");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new CalcPayloadStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new CalcPayloadTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CalcPayload.class, metaDataMap);
  }
   ...
   */
  public CalcPayload(CalcPayload other) {
  ...
  public CalcPayload deepCopy() {
    return new CalcPayload(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof CalcPayload)
      return this.equals((CalcPayload)that);
    return false;
  }

  public boolean equals(CalcPayload that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(CalcPayload other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("CalcPayload(");
    boolean first = true;
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!isSetNum1()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'num1' is unset! Struct:" + toString());
    }

    if (!isSetNum2()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'num2' is unset! Struct:" + toString());
    }
  ...
  private static class CalcPayloadStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public CalcPayloadStandardScheme getScheme() {
      return new CalcPayloadStandardScheme();
    }
  }

  private static class CalcPayloadStandardScheme extends org.apache.thrift.scheme.StandardScheme<CalcPayload> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CalcPayload struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CalcPayload struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CalcPayloadTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public CalcPayloadTupleScheme getScheme() {
      return new CalcPayloadTupleScheme();
    }
  }

  private static class CalcPayloadTupleScheme extends org.apache.thrift.scheme.TupleScheme<CalcPayload> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CalcPayload struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CalcPayload struct) throws org.apache.thrift.TException {
